...
const PricingTable = () => (
  <section className={tw(`bg-white pt-12 pb-12`)}>
    <div className={tw(`relative max-w-6xl mx-auto`)}>
      <div className={tw(`overflow-hidden lg:max-w-none lg:flex`)}>
        <div className={tw(`py-8 px-6 md:px-0 lg:flex-shrink-1`)}>
          <h2 className={tw(`text-4xl lg:text-7xl font-bold text-primary mb-12`)}>Are you ready?</h2>
          <p className={tw(`mt-6 text-base leading-6 text-tertiary`)}>
          ...
          <div className={tw(`mt-8`)}>
            <div className={tw(`flex items-center`)}>
              <h3
                ...
                tracking-wider font-semibold uppercase text-primary`
                )}>
                What is included
              </h3>
              ...
              {features.map((feature) => (
                <li className={tw(`flex items-center lg:col-span-1`)} key={feature}>
                  <div className={tw(`flex-shrink-0`)}>
                    <Check className={tw(`h-8 w-8 mr-3 mb-1 text-success`)} fill="currentColor" />
                  </div>
                  <p className={tw(`text-tertiary`)}>{feature}</p>
                </li>
              ))}
            </ul>
          </div>
